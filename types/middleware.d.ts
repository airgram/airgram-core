...
export interface MiddlewareOn<ContextT = {}> {
  ...
  (
    predicateTypes: 'addProxy', ...fns: Middleware<RequestContext<api.AddProxyParams, api.ProxyUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'blockUser', ...fns: Middleware<RequestContext<api.BlockUserParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'close', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'closeChat', ...fns: Middleware<RequestContext<api.CloseChatParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'deleteSavedOrderInfo', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'destroy', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'disableProxy', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getChat', ...fns: Middleware<RequestContext<api.GetChatParams, api.ChatUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getChats', ...fns: Middleware<RequestContext<api.GetChatsParams, api.ChatsUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getContacts', ...fns: Middleware<RequestContext<never, api.UsersUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'getCountryCode', ...fns: Middleware<RequestContext<never, api.TextUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getCurrentState', ...fns: Middleware<RequestContext<never, api.UpdatesUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getFile', ...fns: Middleware<RequestContext<api.GetFileParams, api.FileUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getInviteText', ...fns: Middleware<RequestContext<never, api.TextUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getLogStream', ...fns: Middleware<RequestContext<never, api.LogStreamUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getLogTags', ...fns: Middleware<RequestContext<never, api.LogTagsUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getMe', ...fns: Middleware<RequestContext<never, api.UserUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getProxies', ...fns: Middleware<RequestContext<never, api.ProxiesUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getSupportUser', ...fns: Middleware<RequestContext<never, api.UserUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'getUser', ...fns: Middleware<RequestContext<api.GetUserParams, api.UserUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'joinChat', ...fns: Middleware<RequestContext<api.JoinChatParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'leaveChat', ...fns: Middleware<RequestContext<api.LeaveChatParams, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'logOut', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'openChat', ...fns: Middleware<RequestContext<api.OpenChatParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'setAlarm', ...fns: Middleware<RequestContext<api.SetAlarmParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'setBio', ...fns: Middleware<RequestContext<api.SetBioParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'setName', ...fns: Middleware<RequestContext<api.SetNameParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'setOption', ...fns: Middleware<RequestContext<api.SetOptionParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'stopPoll', ...fns: Middleware<RequestContext<api.StopPollParams, api.OkUnion> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'testCallBytes',
    ...fns: Middleware<RequestContext<api.TestCallBytesParams, api.TestBytesUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallEmpty', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallString',
    ...fns: Middleware<RequestContext<api.TestCallStringParams, api.TestStringUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallVectorInt',
    ...fns: Middleware<RequestContext<api.TestCallVectorIntParams, api.TestVectorIntUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallVectorIntObject',
    ...fns: Middleware<RequestContext<api.TestCallVectorIntObjectParams, api.TestVectorIntObjectUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallVectorString',
    ...fns: Middleware<RequestContext<api.TestCallVectorStringParams, api.TestVectorStringUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testCallVectorStringObject',
    ...fns: Middleware<RequestContext<api.TestCallVectorStringObjectParams, api.TestVectorStringObjectUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testGetDifference', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testNetwork', ...fns: Middleware<RequestContext<never, api.OkUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testSquareInt',
    ...fns: Middleware<RequestContext<api.TestSquareIntParams, api.TestIntUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testUseError', ...fns: Middleware<RequestContext<never, api.ErrorUnion> & ContextT>[]
  ): void;

  (
    predicateTypes: 'testUseUpdate', ...fns: Middleware<RequestContext<never, api.UpdateUnion> & ContextT>[]
  ): void;
...
// Updates
  ...
  (
    predicateTypes: 'updateNewMessage', ...fns: Middleware<UpdateContext<api.UpdateNewMessage> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateMessageEdited', ...fns: Middleware<UpdateContext<api.UpdateMessageEdited> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateMessageViews', ...fns: Middleware<UpdateContext<api.UpdateMessageViews> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateNewChat', ...fns: Middleware<UpdateContext<api.UpdateNewChat> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateChatTitle', ...fns: Middleware<UpdateContext<api.UpdateChatTitle> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateChatPhoto', ...fns: Middleware<UpdateContext<api.UpdateChatPhoto> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateChatOrder', ...fns: Middleware<UpdateContext<api.UpdateChatOrder> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateChatIsPinned', ...fns: Middleware<UpdateContext<api.UpdateChatIsPinned> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateChatReadInbox', ...fns: Middleware<UpdateContext<api.UpdateChatReadInbox> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateNotification', ...fns: Middleware<UpdateContext<api.UpdateNotification> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateUserStatus', ...fns: Middleware<UpdateContext<api.UpdateUserStatus> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateUser', ...fns: Middleware<UpdateContext<api.UpdateUser> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateBasicGroup', ...fns: Middleware<UpdateContext<api.UpdateBasicGroup> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateSupergroup', ...fns: Middleware<UpdateContext<api.UpdateSupergroup> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateSecretChat', ...fns: Middleware<UpdateContext<api.UpdateSecretChat> & ContextT>[]
  ): void;

  (
    predicateTypes: 'updateUserFullInfo', ...fns: Middleware<UpdateContext<api.UpdateUserFullInfo> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateFile', ...fns: Middleware<UpdateContext<api.UpdateFile> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateCall', ...fns: Middleware<UpdateContext<api.UpdateCall> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updateOption', ...fns: Middleware<UpdateContext<api.UpdateOption> & ContextT>[]
  ): void;
  ...
  (
    predicateTypes: 'updatePoll', ...fns: Middleware<UpdateContext<api.UpdatePoll> & ContextT>[]
  ): void;
